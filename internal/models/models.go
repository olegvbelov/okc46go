...
var Services = []OkcService{
	{
		...
		DetailPlan: []PlanDetail{{"Подготовить документы на замельный участок: <br/><ul><li class=\"template-arrow-right-2\">заявление, составленное в свободной форме;</li><li class=\"template-arrow-right-2\">паспорт владельца;</li><li class=\"template-arrow-right-2\">правоустанавливающие документы на земельный участок;</li><li class=\"template-arrow-right-2\">правоудостоверяющие документы на земельный участок;</li><li class=\"template-arrow-right-2\">кадастровая выписка;</li><li class=\"template-arrow-right-2\">кадастровый паспорт;</li></ul>",
			""},
			{"Заключение договора с кадастровым инженером/землеустроительной организацией", "6000 рублей"},
	...
	},
	{
		...
		DetailUrl:        "/details/2",
		QuestionAnswers: []QuestionAnswer{
			{"accordion-doc", "Какие документы необходимо подготовить для выделение пая?", "Заявление на выдел пая; Документы на право собственности доли в исходном массиве; паспорт заявителя"},
			{"accordion-time", "Сколько по времени занимает выдел пая?", "Процедура занимает от одного до двух месяцев."},
			{"accordion-agreement", "Кто проводит согласование кадастрового плана пая с соседями/другими собственниками?", "Согласование проводит заявитель. В результате должен быть предоставлен документ с согласием всех заинтересованных лиц"},
		},
		Link:           "/services",
		DetailImageUrl: []string{"pie.jpg", "mega.jpg"},
		DetailDescription: []string{"Выделение пая (земельной доли) в натуре из массива сельскохозяйственных земель необходимо для получение самостоятельного земельного участка в собственность.",
			"При выделении пая собственник получает выделенный земельный участок в собственность, но теряет право на долевую собственност в исходном сельскохозяйственном массиве.",
		},
		DetailPlan: []PlanDetail{{"Заключить договор с кадастровым инженером/землеустроительной организацией", "6000 рублей"},
			{"Проведение кадастровым инженером замеров и подготовка проекта межевания земельных участков", ""},
			{"Публикация извещения о выделении пая в печатном издании.", "согласно тарифов печатного издания"},
			{"Согласование плана выделенного участка с другими собственниками и устранение замечаний", ""},
			{"Отправка заявления и кадастрового плана в орган регистрации прав", ""},
			{"Получение выписки из ЕГРН", ""},
		},
	},
	...
	},
	{
		...
		Webp390x260:      "/static/images/okc46/services/390x260/techplan.webp",
		OnMain:           false,
		DetailUrl:        "/details/6",
		QuestionAnswers: []QuestionAnswer{
			{"accordion-owner", "Возможно ли оформление меживание не собственником", "Да, при наличии нотариально заверенной доверенности."},
			{"accordion-passport", "Имеется технический паспорт, выданный БТИ. Возможно ли использовать его для продажи квартиры?", "Нет, необходимо изготовить технический план."},
		},
		Link:           "/services",
		DetailImageUrl: []string{"techplan.jpg", "techplan2.jpg"},
		DetailDescription: []string{"Технический план представляет собой документ, в котором воспроизведены определенные сведения, внесенные в Единый государственный реестр недвижимости, и указаны сведения о здании, сооружении, помещении, машино-месте, объекте незавершенного строительства или едином недвижимом комплексе, необходимые для государственного кадастрового учета такого объекта недвижимости.",
			"Оформление технического плана необходимо: при регистрации права собственности на помещения; для регистрации права собственности на дом с целью продажи; для внесения изменений об объекте в случае реконструкции в ЕГРН.",
		},
		DetailPlan: []PlanDetail{{"Подготовить документы <br/><ul><li class=\"template-arrow-right-2\">Паспорт собственника;</li><li class=\"template-arrow-right-2\">СНИЛС;</li><li class=\"template-arrow-right-2\">правоустанавлиющие документы;</li><li class=\"template-arrow-right-2\">технический план, если он был составлен ранее;</li></ul>", ""},
			{"Заключить договор с кадастровым инженером/землеустроительной организацией", "4000 рублей"},
			{"Получить технический план в электронном виде с квалифицированной электронной подписью кадастрового инженера", ""},
		},
	},
	{
		Id:               "7",
